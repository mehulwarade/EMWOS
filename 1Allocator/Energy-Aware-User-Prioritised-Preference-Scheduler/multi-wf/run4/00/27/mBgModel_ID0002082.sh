...
3-fits.tbl:3-images.tbl:mBgModel
eof
...
pegasus-kickstart  -n mBgModel -N ID0002082 -R condorpool  -s 3-corrections.tbl=3-corrections.tbl -L montage -T 2023-12-14T00:10:51+00:00 ./mBgModel -i 100000 3-images.tbl 3-fits.tbl 3-corrections.tbl
job_ec=$?
