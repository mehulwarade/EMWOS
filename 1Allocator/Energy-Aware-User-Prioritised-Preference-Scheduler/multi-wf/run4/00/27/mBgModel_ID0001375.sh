...
2-images.tbl:mBgModel:2-fits.tbl
eof
...
pegasus-kickstart  -n mBgModel -N ID0001375 -R condorpool  -s 2-corrections.tbl=2-corrections.tbl -L montage -T 2023-12-14T00:10:51+00:00 ./mBgModel -i 100000 2-images.tbl 2-fits.tbl 2-corrections.tbl
job_ec=$?
