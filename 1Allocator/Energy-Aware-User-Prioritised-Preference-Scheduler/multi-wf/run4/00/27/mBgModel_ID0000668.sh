...
pegasus-kickstart  -n mBgModel -N ID0000668 -R condorpool  -s 1-corrections.tbl=1-corrections.tbl -L montage -T 2023-12-14T00:10:51+00:00 ./mBgModel -i 100000 1-images.tbl 1-fits.tbl 1-corrections.tbl
job_ec=$?
