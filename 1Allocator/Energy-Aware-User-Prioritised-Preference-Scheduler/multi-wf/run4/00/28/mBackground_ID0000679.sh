...
/bin/chmod +x mBackground

printf "\n##################### Checking file integrity for input files #####################\n"  1>&2
# do file integrity checks
pegasus-integrity --print-timings --verify=stdin 1>&2 << 'eof'
mBackground:pposs2ukstu_blue_002_005.fits:1-projected.tbl:1-corrections.tbl:pposs2ukstu_blue_002_005_area.fits
eof
...
pegasus-kickstart  -n mBackground -N ID0000679 -R condorpool  -s cposs2ukstu_blue_002_005_area.fits=cposs2ukstu_blue_002_005_area.fits -s cposs2ukstu_blue_002_005.fits=cposs2ukstu_blue_002_005.fits -L montage -T 2023-12-14T00:10:51+00:00 ./mBackground -t pposs2ukstu_blue_002_005.fits cposs2ukstu_blue_002_005.fits 1-projected.tbl 1-corrections.tbl
job_ec=$?
