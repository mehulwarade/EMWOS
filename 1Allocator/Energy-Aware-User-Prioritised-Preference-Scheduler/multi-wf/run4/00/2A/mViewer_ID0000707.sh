...
pegasus-kickstart  -n mViewer -N ID0000707 -R condorpool  -s 1-mosaic.png=1-mosaic.png -L montage -T 2023-12-14T00:10:51+00:00 ./mViewer -ct 1 -gray 1-mosaic.fits -1s max gaussian -png 1-mosaic.png
job_ec=$?
