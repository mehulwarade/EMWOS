...
pegasus-kickstart  -n mViewer -N ID0002121 -R condorpool  -s 3-mosaic.png=3-mosaic.png -L montage -T 2023-12-14T00:10:51+00:00 ./mViewer -ct 1 -gray 3-mosaic.fits -1s max gaussian -png 3-mosaic.png
job_ec=$?
