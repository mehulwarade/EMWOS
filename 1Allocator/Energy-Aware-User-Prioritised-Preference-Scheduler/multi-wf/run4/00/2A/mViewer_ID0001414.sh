...
pegasus-kickstart  -n mViewer -N ID0001414 -R condorpool  -s 2-mosaic.png=2-mosaic.png -L montage -T 2023-12-14T00:10:51+00:00 ./mViewer -ct 1 -gray 2-mosaic.fits -1s max gaussian -png 2-mosaic.png
job_ec=$?
