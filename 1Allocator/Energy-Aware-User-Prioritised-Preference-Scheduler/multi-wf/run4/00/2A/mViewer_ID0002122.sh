...
mViewer:2-mosaic.fits:1-mosaic.fits:3-mosaic.fits
eof
...
pegasus-kickstart  -n mViewer -N ID0002122 -R condorpool  -s mosaic-color.png=mosaic-color.png -L montage -T 2023-12-14T00:10:51+00:00 ./mViewer -red 3-mosaic.fits -0.5s max gaussian-log -green 2-mosaic.fits -0.5s max gaussian-log -blue 1-mosaic.fits -0.5s max gaussian-log -png mosaic-color.png
job_ec=$?
